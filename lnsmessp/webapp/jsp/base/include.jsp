...
<script type="text/javascript" language="javascript" src="<%=path%>/scripts/dialy.js"></script>
<script type="text/javascript" language="javascript" src="<%=path%>/scripts/fuceng.js"></script>
<script type="text/javascript" language="javascript" src="<%=path%>/scripts/scrollOver-jquery-common.js"></script>
<script type="text/javascript" language="javascript" src="<%=path%>/scripts/calendar.js"></script>
