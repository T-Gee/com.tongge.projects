...
<div class="left">
  ...
  <div class="content_detail">
    ...
    <h3>企业用户注册</h3>
    <div class="reg_one">
      <form style="display: inline" id="jvForm" name="jvForm" action="compnayregister.jspx" method="post">
          ...
          <tbody>
            <tr>
              ...
              <td width="506">&nbsp;<input name="title" maxlength="30" style="width: 280px; height: 16px;"
                class="required" type="text"> <img src="<%=path%>/images/circle_03.png"
            ...
            <tr>
              ...
              <td>&nbsp;<input name="username" maxlength="20" style="width: 190px; height: 16px;"
                class="required username" type="text"> <img src="<%=path%>/images/circle_03.png"
                style="vertical-align: middle;">
              </td>
            </tr>
            <tr>
              <td align="right">密码</td>
              <td>&nbsp;<input name="password" id="password" value="" maxlength="19"
            ...
            <tr>
              ...
              <td>&nbsp;<input name="confirm_password" id="confirm_password" value="" class="password2"
            ...
            <tr>
              ...
              <td>&nbsp;<select id="attr_respectiveIndustries" name="attr_respectiveIndustries" class="required">
            ...
            <tr>
              ...
              <td>&nbsp;<input name="author" style="width: 90px; height: 16px;" maxlength="10" class="required"
                onblur="ismoney(this)" type="text">&nbsp;万元 <img src="<%=path%>/images/circle_03.png"
                style="vertical-align: middle;">
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>&nbsp;<input name="attr_companyAddress" maxlength="15" style="width: 280px; height: 16px;"
                type="text">
              </td>
            </tr>
            <tr>
              <td align="right">公司办公地</td>
              <td>&nbsp;<input name="attr_officeCompany" maxlength="50" style="width: 280px; height: 16px;"
                type="text">
              </td>
            </tr>
            <tr>
              <td align="right">公司人数</td>
              <td>&nbsp;<input name="attr_companyNumber" maxlength="10" style="width: 190px; height: 16px;"
            ...
            <tr>
              ...
              <td>&nbsp;<input name="attr_companyLeader" style="width: 190px; height: 16px;" type="text">
              </td>
            </tr>
            <tr>
              <td align="right"></td>
