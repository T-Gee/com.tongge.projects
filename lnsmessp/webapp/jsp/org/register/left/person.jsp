          ...
          <tbody>
            ...
            <tr>
              ...
              <td>&nbsp;<input name="password" id="password" style="width: 190px; height: 16px;" class="required"
                type="password"> <img src="<%=path%>/images/circle_03.png" style="vertical-align: middle;">
              </td>
            </tr>
            <tr>
...
<%--                 src="<%=path%>/images/captcha.jpeg">&nbsp;&nbsp;<a href="javascript:void(0);" onclick="refresh()">看不清楚，换一张</a> --%>
              </td>
            </tr>
          </tbody>
        </table>
